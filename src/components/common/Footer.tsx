...
const socialLinks = [
  {
    ...
    icon: (
      <svg viewBox="0 0 320 512" className="h-[1.1em] w-[1.1em]" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    name: "Twitter",
    href: "https://x.com",
    hoverClass: "group-hover:bg-[#1DA1F2]",
    icon: (
      <svg viewBox="0 0 48 48" className="h-[1.1em] w-[1.1em]" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    hoverClass: "group-hover:bg-[#E4405F]",
    icon: (
      <svg viewBox="0 0 16 16" className="h-[1.1em] w-[1.1em]" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="mt-4 flex flex-wrap gap-4">
            {socialLinks.map((item) => (
              <Link
                ...
                className="group relative inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/95 text-[#05000A] shadow-[0_10px_10px_rgba(0,0,0,0.12)] transition-all duration-300 hover:-translate-y-1 hover:text-white"
              >
                <span className={`absolute -top-11 left-1/2 -translate-x-1/2 rounded-md bg-white px-2 py-1 text-xs font-medium text-[#05000A] opacity-0 shadow-md transition-all duration-300 group-hover:opacity-100 ${item.hoverClass}`}>
                  {item.name}
                </span>
                {item.icon}
              </Link>
